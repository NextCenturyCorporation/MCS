...
def test_rect_intersection():
    ...
    B = [{'x': .25, 'y': 0, 'z': .25}, {'x': .75, 'y': 0, 'z': .25},
         {'x': .75, 'y': 0, 'z': .75}, {'x': .25, 'y': 0, 'z': .75}]
    C = [{'x': .8, 'y': 0, 'z': 1.2}, {'x': 1.1, 'y': 0, 'z': 1.8},
         {'x': 2, 'y': 0, 'z': 1.5}, {'x': 1.1, 'y': 0, 'z': .3}]
    ...
    for target_definition in util.retrieve_full_object_definition_list(
        ...
        target_location = {
            'position': {
                'x': 0, 'y': 0, 'z': 0}, 'rotation': {
                'x': 0, 'y': 0, 'z': 0}}
        target_location['boundingBox'] = generate_object_bounds(
...
def test_does_fully_obstruct_target():
    target_location = {
        'position': {
            ...
            'x': 0, 'y': 0, 'z': 0}}
    target_location['boundingBox'] = generate_object_bounds(
        {'x': 1, 'z': 1}, None, target_location['position'], target_location['rotation'])
    ...
    obstructor_location = {
        ...
        'rotation': {
            ...
            'y': 0,
            'z': 0}}
    obstructor_location['boundingBox'] = generate_object_bounds(
        {'x': 2, 'z': 2}, None, obstructor_location['position'], obstructor_location['rotation'])
...
def test_does_fully_obstruct_target_returns_false_too_small():
    ...
    obstructor_location = {
        ...
        'rotation': {
            ...
            'z': 0}}
    obstructor_location['boundingBox'] = generate_object_bounds(
        {'x': 0.5, 'z': 0.5}, None, obstructor_location['position'], obstructor_location['rotation'])
    obstructor_poly = get_bounding_polygon(obstructor_location)
