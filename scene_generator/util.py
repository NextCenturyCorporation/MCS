...
def finalize_object_definition(object_def: Dict[str,
                                                Any],
                               choice_material: Optional[Dict[str,
                                                              Any]] = None,
                               choice_size: Optional[Dict[str,
                                                          Any]] = None,
                               choice_type: Optional[Dict[str,
                                                          Any]] = None) -> Dict[str,
                                                                                Any]:
...
def finalize_object_materials_and_colors(
        object_definition: Dict[str, Any], override_materials_list: Optional[List[Tuple[str, List[str]]]] = None) -> List[Dict[str, Any]]:
...
def instantiate_object(object_def: Dict[str,
                                        Any],
                       object_location: Dict[str,
                                             Any],
                       materials_list: Optional[List[Tuple[str,
                                                           List[str]]]] = None) -> Dict[str,
                                                                                        Any]:
    ...
    new_object['novelColor'] = (
        object_def['novelColor'] if 'novelColor' in object_def else False) or new_object['novelColor']
...
def check_same_and_different(a: Dict[str,
                                     Any],
                             b: Dict[str,
                                     Any],
                             same: Iterable[str],
                             different: Iterable[str]) -> bool:
...
def get_similar_defs(obj: Dict[str, Any], all_defs: List[Dict[str, Any]],
                     same: Iterable[str], different: Iterable[str]) -> List[Dict[str, Any]]:
...
def move_to_location(object_definition: Dict[str,
                                             Any],
                     object_instance: Dict[str,
                                           Any],
                     location: Dict[str,
                                    Any],
                     object_bounds: List[Dict[str,
                                              float]],
                     previous_definition: Dict[str,
                                               Any]) -> Dict[str,
                                                             Any]:
