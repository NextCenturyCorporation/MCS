...
def random_position_y() -> float:
    return round(random.uniform(ROOM_Y_MIN, ROOM_Y_MAX), POSITION_DIGITS)
...
def calc_obj_coords(position_x: float, position_z: float, delta_x: float,
    ...
    a = {'x': position_x + x_plus * rotate_cos - z_plus * rotate_sin,
         'y': position_y,
         'z': position_z + x_plus * rotate_sin + z_plus * rotate_cos}
    b = {'x': position_x + x_plus * rotate_cos - z_minus * rotate_sin,
         'y': position_y,
         'z': position_z + x_plus * rotate_sin + z_minus * rotate_cos}
    c = {'x': position_x + x_minus * rotate_cos - z_minus * rotate_sin,
         'y': position_y,
         'z': position_z + x_minus * rotate_sin + z_minus * rotate_cos}
    d = {'x': position_x + x_minus * rotate_cos - z_plus * rotate_sin,
         'y': position_y,
         'z': position_z + x_minus * rotate_sin + z_plus * rotate_cos}
