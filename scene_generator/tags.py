...
def append_object_tags_of_type(
    ...
    for obj in objs:
        ...
        novel_color_tag = (
            name +
            ' novel color') if 'novelColor' in obj and obj['novelColor'] else (
            name +
            ' not novel color')
        novel_combination_tag = (
            name +
            ' novel combination') if 'novelCombination' in obj and obj['novelCombination'] else (
            name +
            ' not novel combination')
        novel_shape_tag = (
            name +
            ' novel shape') if 'novelShape' in obj and obj['novelShape'] else (
            name +
            ' not novel shape')
        for new_tag in [
                enclosed_tag,
