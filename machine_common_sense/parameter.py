...
class Parameter:
    ...
    # DW: a lot of these keys can go into Action as well
    # DW: although some constants are pulled in elsewhere
    ...
    def _convert_y_image_coord_for_unity(self, y_coord):
        ...
        '''
        if(y_coord != 0):
            return self.config.get_screen_height() - y_coord
        else:
            return y_coord
    ...
    def get_move_magnitude(self, action: str, force: float,
        ...
        move_magnitude = DEFAULT_MOVE  # DW: comes from controller
