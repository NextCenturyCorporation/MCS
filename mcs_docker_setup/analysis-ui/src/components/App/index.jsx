...
export class Eval extends React.Component {
    render() {
        return (
            <div>
                <ul>
                    <li>{this.props.eval.block}</li>
                    <li>{this.props.eval.complexity}</li>
                    <li>{this.props.eval.ground_truth}</li>
                    <li>{this.props.eval.num_objects}</li>
                    <li>{this.props.eval.occluder}</li>
                    <li>{this.props.eval.performer}</li>
                    <li>{this.props.eval.plausibility}</li>
                    <li>{this.props.eval.scene}</li>
                    <li>{this.props.eval.submission}</li>
                    <li>{this.props.eval.test}</li>
                    <li>{this.props.eval.url_string}</li>
                </ul>
            </div>
        );
    }
...
export class App extends React.Component {
    ...
    render() {
        ...
        return (
            <Query query={msc_eval}>
            {
                ({ loading, error, data }) => {
                    if (loading) return <div>Loading ...</div> 
                    if (error) return <div>Error</div>
                    
                    const evals = data.msc_eval
