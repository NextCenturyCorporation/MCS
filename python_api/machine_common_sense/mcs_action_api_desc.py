...
class MCS_Action_API_DESC(Enum):
    ...
    MOVE_AHEAD = "Move yourself ahead based on your current view. (no params)"
    MOVE_BACK = "Move yourself back based on your current view. (no params)"
    MOVE_LEFT = "Move yourself to your left based on your current view. (no params)"
    MOVE_RIGHT = "Move yourself to your right based on your current view. (no params)"
