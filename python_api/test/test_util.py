...
class Test_Util(unittest.TestCase):
    ...
    def test_input_to_action_and_params(self):
        self.assertEqual(mcs.Util.input_to_action_and_params('MoveBack'), ('MoveBack', {}))
        self.assertEqual(mcs.Util.input_to_action_and_params('RotateLook,rotation=12.34'), ('RotateLook', {
            'rotation': 12.34
        }))
        self.assertEqual(mcs.Util.input_to_action_and_params('PickupObject,objectId=testId'), ('PickupObject', {
            'objectId': 'testId'
        }))
        self.assertEqual(mcs.Util.input_to_action_and_params('PushObject,objectId=testId,force=12.34'), ('PushObject', {
            'objectId': 'testId',
            'force': 12.34
        }))
        self.assertEqual(mcs.Util.input_to_action_and_params('Foobar'), (None, {}))
        self.assertEqual(mcs.Util.input_to_action_and_params('MoveBack,key:value'), ('MoveBack', None))
    ...
    def test_value_to_str_with_list(self):
        self.assertEqual(mcs.Util.value_to_str([]), "[]")
        self.assertEqual(mcs.Util.value_to_str([1, "a"]), "[\n    1,\n    \"a\"\n]")
