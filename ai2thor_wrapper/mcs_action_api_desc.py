...
class MCS_Action_API_DESC(Enum):
    CLOSE_OBJECT = "Close a nearby object. (objectId=string, amount=float, objectDirectionX=float, objectDirectionY=float, objectDirectionZ=float)"
    ...
    OPEN_OBJECT = "Open a nearby object. (objectId=string, amount=float, objectDirectionX=float, objectDirectionY=float, objectDirectionZ=float)"
    ...
    PULL_OBJECT = "Pull a nearby object. (objectId=string, rotation=float, horizon=float, force=float, objectDirectionX=float, objectDirectionY=float, objectDirectionZ=float)"
    PUSH_OBJECT = "Push a nearby object. (objectId=string, rotation=float, horizon=float, force=float, objectDirectionX=float, objectDirectionY=float, objectDirectionZ=float)"
